...
export function Footer() {
  return (
    <footer id="contact" className="w-full py-12 md:py-24 bg-navy-800 text-white">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-300">info@mudaqqiq.ai</span>
              </li>
              <li className="flex items-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-6">
              <Button className="w-full bg-white text-navy-800 hover:bg-gray-200">طلب عرض توضيحي</Button>
            </div>
          </div>
        </div>
