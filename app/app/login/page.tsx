        ...
        <CardContent>
          <form className="space-y-6">
            ...
            <div className="flex justify-between text-sm text-gray-600">
              <Link href="/forgot-password" className="hover:underline text-navy-600">
                نسيت كلمة المرور؟
              </Link>
              <Link href="/register" className="hover:underline text-navy-600">
                إنشاء حساب جديد
              </Link>
            </div>

            <Button className="w-full bg-navy-600 hover:bg-navy-700 text-white mt-4">
              تسجيل الدخول
            </Button>
          </form>
        </CardContent>
